...
checkpoint::checkpoint("2018-08-01", scanForPackages = FALSE) # use the same date when R-3.5.1. was released
...
if (!any(match(fonts(), "Arial"), na.rm = TRUE)) font_import(pattern = "Arial.*")
