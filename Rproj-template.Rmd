...
# Use the same date when R-3.5.1. was released
checkpoint::checkpoint("2018-08-01", scanForPackages = FALSE)
...
# Choose sheet names or numbers
sheet.names <- c("Sheet 1", "Sheet 2", "Sheet 3")

# Load data using purrr and create segment variable based on excel sheet name
df.2018 <- map_df(sheet.names, 
